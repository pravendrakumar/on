...
<head>
  ...
  <title>ONSCEANE | Dashboard</title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>ON</b>CN</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b> Onscene</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo SITE_PATH;?>dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo SITE_PATH;?>dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo SITE_PATH;?>dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Welcome <?php echo ucwords($this->Session->read('Auth.Admin.Admin.username'));?>!</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
          ...
          <li>
            <a href="<?php echo SITE_PATH;?>admin/admins/sign_out" title="Logout"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
